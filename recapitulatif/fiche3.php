    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="recapitulatif3.php" class="nav-item nav-link">récapitulatif</a>
            ...
            while($data_N2 = $info_requet_donnees_fiche_N2->fetch_assoc()){ ?> 
               <div class="card text-center">
                    <div class="card-header" >
                        <h3 class=" text-white"> Fiche : <?php echo($data_N2['fic_Label']."\n"); ?></h3>
                    </div>
                    <div class="card-body">
                        <div class="py-10 d-flex justify-content-center">
                        ...
                        <div class="py-10 d-flex justify-content-center">
                            ...
                            ?>
                            <h5 class="card-title"> Sujet : <?php echo($data_info_requet_sujet_fiche['suj_Intitule']."\n"); ?></h5>
                        </div>
                    ...
                    <div class="card-footer ">
                        <h6 class="text-white"> Ready2Scan</h6>
                       <h6 class="text-white">L2 INFORMATIQUE – UBO</h6>
                       <h6 class="text-white">MARC Valérie</h6>
                       <h6 class="text-white">ALNEZAMI Akram</h6>
                    </div>
                </div>
            <?php  
            }
