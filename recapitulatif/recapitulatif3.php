            ...
            while($sujets = $resultat_requete_sujets->fetch_assoc()){?>
                <div class="container">
                    <div class="row py-2" id="container_suj">
                        <h4 class="text-white"><?php echo($sujets['suj_Intitule']);?></h4>
                    </div>
                    <?php echo"<br>";?>
                    <div class="container">
                        <?php
                                                ...
                                                <div class="card-body" id="card_body">
                                                    ...
                                                    <div class="py-10 d-flex justify-content-center">
                                                        ...
                                                        $requet_id_fiche = "
                                                            SELECT * 
                                                            FROM t_fiche_fic
                                                            WHERE fic_Code = '".$fiches['fic_Code']."';";
                                                        $info_requet_id_fiche = $mysqli->query($requet_id_fiche);
                                                        $id_fiche = $info_requet_id_fiche->fetch_assoc();                                                       ?>
                                                        <a href="fiche3.php?code=<?php echo($id_fiche['fic_Code']); ?>"><input type="button" class="btn btn-primary btn-lg btn-block" value="Voir Plus"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
