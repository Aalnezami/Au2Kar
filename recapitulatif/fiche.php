    ...
    <div class="container">
        ...
        /* NIVEAU 1
            ...
            while($data = $info_requet_donnees_fiche->fetch_assoc()){
                echo($data['fic_Label']."\n");
                echo"<br>";
                echo($data['fic_Contenu']."\n");
                echo"<br>";
                echo($data['fic_Fichier_Img']."\n");
            }
        */
        // ******************************************************************************************************
        ...
        while($data_N2 = $info_requet_donnees_fiche_N2->fetch_assoc()){ ?>
            <div class="card">
                <h2 class="card-header"> Fiche : <?php echo($data_N2['fic_Label']."\n"); ?></h2>
                <div class="card-body">
                    <div class="container">
                        <div class="card mb-3" >
                            <div class="row g-0">
                    ...
                    <div class="row py-2" id="container_suj">
                        <h4>hyperliens associés à la fiche : </h4>
                    </div>
                    <div class="container py-10">
                        <ul>
                        <?php
                        for($i=0; $i<5; $i++){
                            echo("<li><h3> testoooooooooo</h3></li>");
                        }
                        ?>
                        </ul>
                    </div>
