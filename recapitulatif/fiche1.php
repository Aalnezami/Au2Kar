...
<body>
    ...
    <div class="container">
        <?php
            $requet_donnees_fiche = "
                SELECT * 
                FROM t_fiche_fic
                WHERE fic_Numero = '".$_GET['id']."';";

            $info_requet_donnees_fiche = $mysqli->query($requet_donnees_fiche);
            while($data = $info_requet_donnees_fiche->fetch_assoc()){ ?>
                <div class="card">
                    <div>
                        <h2> <?php echo($data['fic_Label']."\n"); ?></h2>
                    </div>
                    <br>
                    <div>
                        <p><?php echo($data['fic_Fichier_Img']."\n");?></p>
                    </div>
                    <br>
                    <div>
                        <h4> Sujet : <?php echo($data['fic_Label']."\n"); ?></h4>
                    </div>
                    <br>
                    <div class="row">
                        <div class="col-2"></div>
                        <div>
                            <p class="card-text"><?php echo($data['fic_Contenu']."\n"); ?></p>
                        </div>
                        <div class="col-2"></div>
                    </div>
                    <?php echo"<br>"; ?>
                    <div>
                        <ul>
                            ...
                            $requet_hyperlien ="
                                ...
                                WHERE fic_Numero = '".$data['fic_Numero']."';";
                            ...
                            while($data_hyperlien = $info_requet_hyperlien->fetch_assoc()){?>
                                <li><?php echo($data_hyperlien['hyp_URL']) ?></li>
                        <?php }
                            ?>
                        </ul>
                    </div>
